...
router.get('/',
  protect,
  authorize('DRH', 'SUPER_ADMIN', 'MANAGER', 'RESP_PAIE'),
  getCandidatures
);

router.get('/acceptees',
  protect,
  authorize('RESP_PAIE', 'SUPER_ADMIN'),
  getCandidaturesAcceptees
);

router.get('/acceptees/sans-contrat',
  protect,
  authorize('RESP_PAIE', 'SUPER_ADMIN'),
  getCandidaturesAccepteesSansContrat
);
...
router.post('/offre/:offreId/classifier', 
  protect,
  authorize('DRH', 'SUPER_ADMIN'),
  classifierCandidaturesOffre
);
...
router.post('/:candidatureId/envoyer-fiche',
  protect,
  authorize('DRH', 'SUPER_ADMIN'),
  envoyerFicheRenseignement
);
