-- CreateEnum
CREATE TYPE "Role" AS ENUM ('SUPER_ADMIN', 'MANAGER', 'DIRECTEUR', 'DRH', 'DAF', 'DGA', 'DG', 'RESP_PAIE', 'EMPLOYE');
...
-- CreateEnum
CREATE TYPE "StatutDemande" AS ENUM ('BROUILLON', 'SOUMISE', 'EN_VALIDATION_MANAGER', 'EN_VALIDATION_DIR', 'EN_VALIDATION_DRH', 'EN_VALIDATION_DAF', 'EN_VALIDATION_DGA', 'EN_VALIDATION_DG', 'EN_VALIDATION_CONSEIL', 'VALIDEE', 'REJETEE', 'ANNULEE');

-- CreateEnum
CREATE TYPE "DecisionEtape" AS ENUM ('EN_ATTENTE', 'VALIDEE', 'REFUSEE', 'MODIFIEE');

-- CreateEnum
CREATE TYPE "CircuitType" AS ENUM ('TECHNICIEN', 'EMPLOYE', 'CADRE_DEBUTANT', 'CADRE_CONFIRME', 'CADRE_SUPERIEUR', 'STRATEGIQUE');

-- CreateEnum
CREATE TYPE "TypeEntretien" AS ENUM ('RH', 'TECHNIQUE', 'DIRECTION');

-- CreateEnum
CREATE TYPE "DecisionEvaluationPE" AS ENUM ('CONFIRMATION', 'PROLONGATION', 'RUPTURE', 'CHANGEMENT');

-- CreateEnum
CREATE TYPE "StatutEvaluationPE" AS ENUM ('BROUILLON', 'EN_VALIDATION_DIR', 'EN_VALIDATION_DRH', 'EN_VALIDATION_DAF', 'EN_VALIDATION_DGA', 'EN_VALIDATION_DG', 'VALIDEE', 'REJETEE');
...
CREATE TABLE "demandes" (
    ...
    "commentaireMotif" TEXT,
    "personneRemplaceeNom" TEXT,
    "fonctionRemplacee" TEXT,
    ...
    "niveau" "CircuitType" NOT NULL DEFAULT 'CADRE_CONFIRME',
...
CREATE TABLE "candidatures" (
    ...
    "ficheRenseignementEnvoyee" BOOLEAN NOT NULL DEFAULT false,
    "ficheRenseignementEnvoyeeAt" TIMESTAMP(3),
    "ficheRenseignementRecue" BOOLEAN NOT NULL DEFAULT false,
    "ficheRenseignementRecueAt" TIMESTAMP(3),
    "ficheRenseignementToken" TEXT,
    "ficheRenseignementData" JSONB,
    "offreId" TEXT,
...
CREATE TABLE "evaluations_pe" (
    ...
    "justificationRupture" TEXT,
    "evaluationN1" TEXT,
    "commentaireN1" TEXT,
    "dateSoumissionN1" TIMESTAMP(3),
    "evaluationN2" TEXT,
    "commentaireN2" TEXT,
    "dateDecisionN2" TIMESTAMP(3),
    "evaluationN1Masquee" BOOLEAN NOT NULL DEFAULT false,
    "statut" "StatutEvaluationPE" NOT NULL DEFAULT 'BROUILLON',
    "etapeActuelle" INTEGER NOT NULL DEFAULT 0,
    "totalEtapes" INTEGER NOT NULL DEFAULT 5,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "valideeAt" TIMESTAMP(3),
...
-- CreateTable
CREATE TABLE "evaluations_validations" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "evaluations_validations_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "offres_lienCandidature_key" ON "offres"("lienCandidature");
...
-- CreateIndex
CREATE UNIQUE INDEX "candidatures_ficheRenseignementToken_key" ON "candidatures"("ficheRenseignementToken");
...
-- CreateIndex
CREATE UNIQUE INDEX "evaluations_pe_reference_key" ON "evaluations_pe"("reference");
...
-- AddForeignKey
ALTER TABLE "demandes" ADD CONSTRAINT "demandes_createurId_fkey" FOREIGN KEY ("createurId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "candidatures" ADD CONSTRAINT "candidatures_offreId_fkey" FOREIGN KEY ("offreId") REFERENCES "offres"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "contrats" ADD CONSTRAINT "contrats_candidatureId_fkey" FOREIGN KEY ("candidatureId") REFERENCES "candidatures"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "evaluations_validations" ADD CONSTRAINT "evaluations_validations_evaluationId_fkey" FOREIGN KEY ("evaluationId") REFERENCES "evaluations_pe"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "evaluations_validations" ADD CONSTRAINT "evaluations_validations_acteurId_fkey" FOREIGN KEY ("acteurId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
