...
CREATE TABLE "types_poste" (
    ...
    CONSTRAINT "types_poste_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "types_poste_code_key" ON "types_poste"("code");
...
-- AddForeignKey
ALTER TABLE "types_poste" ADD CONSTRAINT "types_poste_directionId_fkey" FOREIGN KEY ("directionId") REFERENCES "directions"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "demandes" ADD CONSTRAINT "demandes_typePosteId_fkey" FOREIGN KEY ("typePosteId") REFERENCES "types_poste"("id") ON DELETE SET NULL ON UPDATE CASCADE;
