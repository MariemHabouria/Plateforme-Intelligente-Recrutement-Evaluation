...
export const ROLES: Record<Role, RoleConfig> = {
  ...
  dga:        { label: 'DGA / DG',          color: '#7A5A3A', initials: 'NK', name: 'Nabil Kilani',    sub: 'Directeur Général Adjoint' },
...
export const NAV_CONFIG: Record<string, NavItem[]> = {
  ...
  manager: [
    ...
    { section: 'Suivi' },
    { id: 'validation', label: 'Circuit validation', icon: 'CheckSquare' },
  ],
  directeur: [
    { section: 'Espace de travail' },
    { id: 'dashboard',  label: 'Tableau de bord',      icon: 'LayoutDashboard' },
    { id: 'validation', label: 'À valider',             icon: 'CheckSquare', badge: '3', badgeColor: 'amber' },
    { id: 'demandes',   label: 'Demandes',              icon: 'FileText' },
    { section: 'Période d\'essai' },
    { id: 'evaluation', label: 'Évaluation PE (N+2)',   icon: 'Star', badge: '2', badgeColor: 'amber' },
  ],
  rh: [
    { section: 'Recrutement' },
    { id: 'dashboard',  label: 'Tableau de bord',    icon: 'LayoutDashboard' },
    ...
    { section: 'Gestion RH' },
    { id: 'evaluation', label: 'Évaluation PE',       icon: 'Star' },
    { id: 'contrats',   label: 'Contractualisation',  icon: 'FileCheck', badge: '3', badgeColor: 'amber' },
  ],
  daf: [
    { section: 'Validation financière' },
    { id: 'dashboard',  label: 'Tableau de bord', icon: 'LayoutDashboard' },
    { id: 'validation', label: 'À valider (DAF)',  icon: 'CheckSquare', badge: '2', badgeColor: 'amber' },
    { id: 'demandes',   label: 'Demandes',         icon: 'FileText' },
    { section: 'Période d\'essai' },
    { id: 'evaluation', label: 'Évaluation PE',   icon: 'Star', badge: '1', badgeColor: 'amber' },
  ],
  dga: [
    ...
    { id: 'dashboard',  label: 'Tableau de bord', icon: 'LayoutDashboard' },
    { id: 'validation', label: 'À valider (DGA)', icon: 'CheckSquare', badge: '1', badgeColor: 'amber' },
    { id: 'demandes',   label: 'Vue globale',     icon: 'FileText' },
    { section: 'Période d\'essai' },
    { id: 'evaluation', label: 'Évaluation PE',  icon: 'Star', badge: '1', badgeColor: 'amber' },
  ],
  paie: [
    { section: 'Paie & Administration' },
    { id: 'dashboard',  label: 'Tableau de bord', icon: 'LayoutDashboard' },
