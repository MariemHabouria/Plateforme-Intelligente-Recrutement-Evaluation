...
export const NAV_CONFIG: Record<string, NavItem[]> = {
  superadmin: [
    ...
    { id: 'scoring_config', label: 'Scoring IA',             icon: 'Star' },
    { section: 'supervision' },
...
export const OFFRES_MOCK: any[] = [
  { id: '1', reference: 'OFF-2026-011', intitule: 'Chef de projet IT',      statut: 'PUBLIEE',   datePublication: '10/01/2026', typeContrat: 'CDI',   rhId: '1', competences: [], createdAt: '', updatedAt: '' },
  { id: '2', reference: 'OFF-2026-009', intitule: 'Technicien Maintenance', statut: 'PUBLIEE',   datePublication: '05/01/2026', typeContrat: 'CDD',   rhId: '1', competences: [], createdAt: '', updatedAt: '' },
  { id: '3', reference: 'OFF-2026-007', intitule: 'Ingenieur Qualite',      statut: 'BROUILLON', datePublication: '15/01/2026', typeContrat: 'CDI',   rhId: '1', competences: [], createdAt: '', updatedAt: '' },
  { id: '4', reference: 'OFF-2026-004', intitule: 'Stagiaire Marketing',    statut: 'CLOTUREE',  datePublication: '20/12/2025', typeContrat: 'STAGE', rhId: '1', competences: [], createdAt: '', updatedAt: '' },
];

export const CANDIDATURES: any[] = [
  { id: '1', reference: 'CAND-001', nom: 'Aymen Bouslama', prenom: 'Aymen', email: 'aymen@example.com', cvUrl: '', offre: OFFRES_MOCK[0], statut: 'PRESELECTIONNEE', scoreGlobal: 87, scoreExp: 91, competencesDetectees: ['React', 'Node.js', 'Agile', 'Docker'], competencesManquantes: [], consentementRGPD: true, consentementIA: true, dateSoumission: '2026-01-10' },
  { id: '2', reference: 'CAND-002', nom: 'Rim Chaabane',   prenom: 'Rim',   email: 'rim@example.com',   cvUrl: '', offre: OFFRES_MOCK[0], statut: 'NOUVELLE',        scoreGlobal: 82, scoreExp: 78, competencesDetectees: ['Vue.js', 'PostgreSQL', 'CI/CD'],        competencesManquantes: [], consentementRGPD: true, consentementIA: true, dateSoumission: '2026-01-11' },
  { id: '3', reference: 'CAND-003', nom: 'Karim Sfaxi',    prenom: 'Karim', email: 'karim@example.com', cvUrl: '', offre: OFFRES_MOCK[1], statut: 'NOUVELLE',        scoreGlobal: 74, scoreExp: 82, competencesDetectees: ['Electrique', 'Pneumatique', 'GMAO'],    competencesManquantes: [], consentementRGPD: true, consentementIA: true, dateSoumission: '2026-01-12' },
  { id: '4', reference: 'CAND-004', nom: 'Nour Jlassi',    prenom: 'Nour',  email: 'nour@example.com',  cvUrl: '', offre: OFFRES_MOCK[0], statut: 'REFUSEE',         scoreGlobal: 65, scoreExp: 60, competencesDetectees: ['JavaScript', 'HTML/CSS'],               competencesManquantes: [], consentementRGPD: true, consentementIA: true, dateSoumission: '2026-01-13' },
  { id: '5', reference: 'CAND-005', nom: 'Sami Ben Amor',  prenom: 'Sami',  email: 'sami@example.com',  cvUrl: '', offre: OFFRES_MOCK[1], statut: 'PRESELECTIONNEE', scoreGlobal: 79, scoreExp: 85, competencesDetectees: ['Hydraulique', 'GMAO', 'Soudure'],       competencesManquantes: [], consentementRGPD: true, consentementIA: true, dateSoumission: '2026-01-14' },
];

export const ENTRETIENS: any[] = [
  { id: '1', candidatureId: '1', candidature: CANDIDATURES[0], type: 'RH',        date: '2026-01-20', heure: '10:00', lieu: 'Siege Kilani',    statut: 'PLANIFIE', interviewerId: '1' },
  { id: '2', candidatureId: '2', candidature: CANDIDATURES[1], type: 'TECHNIQUE', date: '2026-01-22', heure: '14:30', lieu: 'Salle A3',        statut: 'PLANIFIE', interviewerId: '1' },
  { id: '3', candidatureId: '5', candidature: CANDIDATURES[4], type: 'RH',        date: '2026-01-23', heure: '09:00', lieu: 'Teams',           statut: 'PLANIFIE', interviewerId: '1' },
  { id: '4', candidatureId: '3', candidature: CANDIDATURES[2], type: 'TECHNIQUE', date: '2026-01-25', heure: '11:00', lieu: 'Usine B. Cedria', statut: 'PLANIFIE', interviewerId: '1' },
];

export const EVALUATIONS_PE: any[] = [
  { id: '1', employeId: '1', managerId: '1', contratId: '1', dateDebut: '2025-07-21', dateFin: '2026-02-21', joursRestants: 24, etapeActuelle: 'manager',   decision: null,           commentaire: null, commentaireManager: null },
  { id: '2', employeId: '2', managerId: '1', contratId: '2', dateDebut: '2025-10-22', dateFin: '2026-04-22', joursRestants: 82, etapeActuelle: 'directeur', decision: 'CONFIRMATION', commentaire: null, commentaireManager: 'CONFIRMATION' },
  { id: '3', employeId: '3', managerId: '1', contratId: '3', dateDebut: '2025-09-01', dateFin: '2026-03-01', joursRestants: 32, etapeActuelle: 'rh',        decision: 'CONFIRMATION', commentaire: null, commentaireManager: 'CONFIRMATION' },
  { id: '4', employeId: '4', managerId: '1', contratId: '4', dateDebut: '2025-11-01', dateFin: '2026-05-01', joursRestants: 90, etapeActuelle: 'daf',       decision: null,           commentaire: null, commentaireManager: null },
];

export const CONTRATS: any[] = [
...
export const VALIDATIONS: any[] = [
  { id: '1', demandeId: '1', niveauEtape: 1, acteurId: '1', decision: 'EN_ATTENTE', dateLimite: '2026-02-01', createdAt: '2026-01-01' },
  { id: '2', demandeId: '2', niveauEtape: 2, acteurId: '1', decision: 'EN_ATTENTE', dateLimite: '2026-02-01', createdAt: '2026-01-01' },
